...
micropython_version:  ## print micropython unix port version
	docker run -it jedie/micropython:latest /mpy/micropython/ports/unix/micropython -c "import sys;print(sys.implementation)"

mpy_cross_version: ## print mpy_cross version
	docker run -it jedie/micropython:latest /mpy/micropython/mpy-cross/mpy-cross --version
